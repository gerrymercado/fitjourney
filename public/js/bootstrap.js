...
function calc_BMI() {
    ...
    0 == b ? ($("#bmi_value").text(""), $("#bmi_level").text(" "), $("#indicator").text("Please complete the form!")) : (a = 1E4 * a / (b * b), $("#bmi_value").text(a.toFixed(2)), 30 < a ? ($("#bmi_level").text("Obese"), $("#indicator").text("You are overweight...")) : 25 < a ? ($("#bmi_level").text("Overweight"), $("#indicator").text("You are overweight... ")) : 18.5 < a ? ($("#bmi_level").text("Normal"), $("#indicator").text("Congratulations, your body is in good condition!")) : 16.5 < a ? ($("#bmi_level").text("Underweight"), $("#indicator").text("Seems you need more food...are you still on a diet?")) : 0 < a ? ($("#bmi_level").text("Serverely Underweight"), $("#indicator").text("Don't stay in computer! You should stay in dinner desk!")) : ($("#bmi_value").text(""), $("#bmi_level").text(""), $("#indicator").text("Please complete the form!")))
}
