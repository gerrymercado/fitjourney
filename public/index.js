...
var ProfileEditPage ={
  ...
  created: function() {
    axios.get("/api/profile/" + this.$route.params.id).then(function(response){
  ...
  submit: function() {
    ...
    axios.patch("/api/profile/" + this.$route.params.id, params)
      .then(function(response) {
        router.push("/profile");
      }.bind(this))
      .catch(
...
var DeleteProfile ={
  ...
  created: function() {
    axios.delete("/api/profile/" + this.$route.params.id).then(function(response){
      this.name = response.data.name;
      this.email = response.data.email;
      this.weight = response.data.weight;
      this.goals = response.data.goals;
...
var MealsShowPage = {
  ...
  created: function(){
    axios.get("api/meals/" + this.$route.params.id).then(function(response){
  ...
  methods: {
    DeleteMeal: function(){
      axios.delete("api/meals/" + this.$route.params.id).then(function(response){
        this.meal = response.data;
        console.log(this.meal);
        router.push("/meals");
      }.bind(this));
